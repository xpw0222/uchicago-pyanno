...
class PosteriorPlot(PyannoPlotContainer):
    ...
    posterior_plot = Instance(CMapImagePlot)
    ...
    def _posterior_plot_default(self):
        ...
        img_plot.aspect_ratio = float(nclasses) / nannotations
        self.plot_height = int(self.plot_width / img_plot.aspect_ratio)

        self.decorate_plot(img_plot, self.posterior)
        return img_plot
